                                                    ...
                                                    <div class="panel-heading">新模版设置</div>
                                                        <div class="panel-body">
                                                           ...
                                                           <div class="form-group">
	                                                        ...
	                                                        <div class="form-group">
	                                                                ...
	                                                                <div class="col-xs-12 col-sm-9">
	                                                                    ...
	                                                                    <label class="radio-inline"><input type="radio" name="itemewm" value="1"
	                                                                     ...
	                                                                     <?php  if($settings['itemewm']==2) { ?> checked="checked" <?php  } ?>>淘口令页面</label>
	                                                        ...
	                                                        <div class="form-group">
	                                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">拼多多文案</label>
		                                                            <div class="col-sm-9 col-xs-12">
		                                                                ...
		                                                                <div class="help-block" style="line-height:30px;">
			                                                                ...
			                                                                <br>奖励：#奖励##换行#
			                                                                <br>拼多多链接：#拼多多短网址##换行#
			                                                                <br><b style="color:#ff0000">注：这里的文案只有公众号查询拼多多商品才有效</b>
			                                                              </div>
		                                                            </div>
	                                                        </div>
