...
<head>
	...
	<!--[if lt IE 9]> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/js/ie/html5shiv.js" cache="false"></script> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/js/ie/respond.min.js" cache="false"></script> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/js/ie/excanvas.js" cache="false"></script> 
	<![endif]-->
	...
	<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/style/css/common.css" >
    <!--<link rel="stylesheet" href="./resource/css/font-awesome.min.css" type="text/css" />-->
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/style/css/animate.min.css" type="text/css" />
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/style/css/style.min.css" type="text/css" />
	...
	<section class="vbox">
       <!--头部开始-->
		<header class="bg-black dk header navbar navbar-fixed-top-xs">
		    <div class="navbar-header aside-md"> <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen" data-target="#nav"> <i class="fa fa-bars"></i> </a> <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/public/images/logo.png" style="max-height: 30px;margin-top:11px;" class="m-r-sm"></a> <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".nav-user"> <i class="fa fa-cog"></i> </a> </div>
