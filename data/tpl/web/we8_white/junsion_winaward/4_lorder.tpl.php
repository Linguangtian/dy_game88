...
<ul class="nav nav-tabs">
	<li class="active"><a href="<?php  echo $this->createWebUrl('lorder')?>">等级订单</a></li>
</ul>
<?php  if($op == 'display') { ?>
<style>
th{
...
<div class="panel panel-info">
        ...
        <div class="panel-body">
                ...
                <input type="hidden" name="do" value="lorder" />
                <div class="form-group">
                    ...
                    <label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">等级名称</label>
                    <div class="col-xs-12 col-sm-2 col-lg-2">
                        <input class="form-control" name="g_kwd" type="text" value="<?php  echo $_GPC['g_kwd'];?>" placeholder="请输入等级名称">
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="table-responsive panel-body">
        <table class="table table-hover">
            ...
            <tr>
               ...
               <td>
                   <a class="btn btn-danger btn-sm" onclick="return confirm('确认删除吗？');return false;" href="<?php  echo $this->createWebUrl('lorder', array('op' => 'del', 'id' => $item['id']))?>">删除</a>
                </td>
            </tr>
            <?php  } } ?>
            </tbody>
