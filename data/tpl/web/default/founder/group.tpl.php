...
<table class="table we7-table table-hover" id="js-vice-group-display" ng-controller="ViceGroupDisplay" ng-cloak>
	...
	<tr ng-repeat="list in lists">
		...
		<td><span ng-if="list.maxphoneapp == 0">无权限</span><span ng-if="list.maxphoneapp != 0" ng-bind="list.maxphoneapp"></span></td>
		<td>
		...
		<td>
			<span ng-if="list.phoneapp_nums == -1">全部</span>
			<span ng-if="list.phoneapp_nums != -1" ng-bind="list.phoneapp_nums"></span>
		</td>
		<td>
