<?php
 global $_W, $_GPC;
        ...
        if($op=='qb'){//全部
            $order = pdo_fetchall("select * from ".tablename($this->modulename."_pddtjorder")." where weid='{$_W['uniacid']}' and openid='{$fans['openid']}' order by id desc");
            //echo "<pre>";
            //print_r($order);
            //exit;
