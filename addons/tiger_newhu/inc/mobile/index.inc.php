...
//        	exit;
        	...
        	$fzlist = pdo_fetchall("select * from ".tablename($this->modulename."_fztype")." where weid='{$weid}'  order by px desc");
       	    $fzlist8 = pdo_fetchall("select * from ".tablename($this->modulename."_fztype")." where weid='{$weid}'  order by px desc limit 10");
      }
...
//      exit;
       ...
       include $this->template ( 'tbgoods/style99/index' );